...
export const DevicesWatering = {
  ...
  LOAD_STATS_REQUEST: prefix + 'LOAD_STATS_REQUEST',
  LOAD_STATS_SUCCESS: prefix + 'LOAD_STATS_SUCCESS',
  LOAD_STATS_FAILURE: prefix + 'LOAD_STATS_FAILURE',
  ...
  DOWNLOAD_OPERATIONAL_RECORDS_REQUEST: prefix + 'DOWNLOAD_OPERATIONAL_RECORDS_REQUEST',
  DOWNLOAD_OPERATIONAL_RECORDS_SUCCESS: prefix + 'DOWNLOAD_OPERATIONAL_RECORDS_SUCCESS',
  DOWNLOAD_OPERATIONAL_RECORDS_FAILURE: prefix + 'DOWNLOAD_OPERATIONAL_RECORDS_FAILURE',
}
