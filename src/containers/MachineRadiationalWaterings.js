...
class MachineRadiationalWaterings extends Component {
  constructor(props) {
    super(props);
    this.state = {app: 'radiational_watering'};
    this.logger = new Logger({prefix: 'MachineRadiationalWaterings'});
  }
