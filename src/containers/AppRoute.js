...
import MachineRadiationalWaterings from './MachineRadiationalWaterings';
      ...
      return (
        <AppLayout match={match} rest={rest}>
          <Switch>
            ...
            <Route path={`${match.url}/machine_radiational_waterings`} component={MachineRadiationalWaterings} />
